const fr: any = {
  ...
  about: {
    1: {
      q: "Pourquoi ce site&nbsp;?",
      a: "Le site répond à quelques idées reçues très courantes sur Nietzsche et sa philosophie. Ces idées reçues se trouvent à la fois dans le grand public et chez les professionnels de la philosophie. Le site souhaite mettre à mal ces opinions afin de permettre une lecture plus fidèle de Nietzsche, non encombrée de remords ou de réticences inavouées.",
    },
    2: {
      q: "Pourquoi croire à ce qui est écrit ici plutôt qu'ailleurs&nbsp;?",
      a: "Le site est toujours en construction mais à l'avenir il proposera une liste des sources utilisées et consultables pour chaque point abordé. Partant, le lecteur sceptique pourra aller vérifier ces sources.",
    },
    3: {
      q: "Comment savoir si les réponses apportées ne sont pas une interprétation parmi d'autres&nbsp;?",
      a: "Le site a été pensé pour retirer les obstacles à une lecture la moins malhonnête possible de Nietzsche. Il a pour seule ambition d'apporter une réponse au lecteur qui s'interroge sur ces aspects polémiques pouvant « contrarier » la lecture. Le lecteur de mauvaise foi, déjà convaincu, peu courageux, se contentera toujours de ce qu'il croit déjà savoir.",
    },
    4: {
      q: "D'accord, mais sur quoi s'appuient les réponses du site&nbsp;?",
      a: "Les textes rédigés s'inspirent très largement des ouvrages d'introduction suivants : <ul><li><a href='https://www.placedeslibraires.fr/livre/9782070398980-nietzsche-dorian-astor/'>Nietzsche</a> de Dorian Astor, Folio (2011) [biographie]</li><li><a href='https://www.placedeslibraires.fr/livre/9782846702706-nietzsche-patrick-wotling/'>Nietzsche</a> de Patrick Wotling, Le Cavalier Bleu (2009)</li><li><a href='https://www.placedeslibraires.fr/livre/9782081218086-la-philosophie-de-l-esprit-libre-introduction-a-nietzsche-patrick-wotling/'>La philosophie de l'esprit libre : Introduction à Nietzsche</a> de Patrick Wotling, Flammarion (2008) [recueil d'articles]</li><li><a href='https://www.placedeslibraires.fr/livre/9782490579983-les-foudres-de-nietzsche-et-l-aveuglement-des-disciples-jacques-bouveresse/'>Les foudres de Nietzsche et l'aveuglement des disciples </a> de Jacques Bouveresse, Hors d'atteinte (2021)</li></ul>",
    },
    5: {
      q: "J'ai lu dans le livre de X ou dans le dossier du magazine Y le contraire de ce qui est écrit sur le site.",
      a: "<p>Les dossiers des magazines préfèrent souvent faire forte impression plutôt que de restituer une interprétation la plus fidèle possible (et la moins sexy souvent).</p><p>Les interprétations de Nietzsche sont nombreuses et souvent opposées. Avant les années 1960, aucune édition tout à fait fiable des œuvres complètes n'est disponible pour la recherche. L'histoire des éditions précédentes est houleuse. La forme nouvelle et le caractère impertinent de la philosophie de Nietzsche autorise également des lectures souvent brillantes mais rarement très fidèles.</p><p>C'est à chaque lecteur de tester attentivement la validité de telle ou telle interprétation en regard de la totalité du texte du philosophe.</p>",
    },
  },
  licence: {
    1: {
